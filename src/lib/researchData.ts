export interface ResearchPaper {
  ...
  url?: string;
  icon: string;           // emoji
  dateAdded?: string;     // ISO "YYYY-MM-DD" — set only for papers in the rolling "Latest research" feed
}
...
export const RESEARCH_PAPERS: ResearchPaper[] = [
  ...
  // ── Latest research (rolling feed, last ~2 months) ─────────────────────────
  {
    id: "from-agi-to-asi",
    title: "From AGI to ASI",
    shortTitle: "From AGI to ASI",
    authors: "Genewein, Franklin, Lerchner, Orseau, Albanie, Legg, Hutter et al.",
    institution: "Google DeepMind",
    year: 2026,
    month: 6,
    category: "safety",
    tldr: "A roadmap paper analyzing four non-mutually-exclusive pathways by which AGI could transition to artificial superintelligence.",
    whyItMatters:
      "Sets out DeepMind's institutional thinking on what comes after human-level AI, shaping safety and governance planning industry-wide.",
    keyFindings: [
      "Identifies four pathways: scaling compute/data/model size, new algorithms/paradigms, recursive self-improvement, and organizational/collective intelligence.",
      "Argues the actual route to ASI may combine all four pathways rather than any single one.",
      "Co-authored by DeepMind co-founder Shane Legg and Marcus Hutter.",
    ],
    difficulty: "intermediate",
    tags: ["Superintelligence", "AGI", "Forecasting", "DeepMind", "Governance"],
  ...
  },
  {
    ...
    shortTitle: "AI Co-Mathematician",
    authors: "Zheng, von Glehn, Zwols et al.",
    institution: "Google DeepMind",
    year: 2026,
    month: 5,
    category: "agents",
    tldr: "An agentic AI system built to assist professional mathematicians with open research problems, reportedly helping crack a 60-year-old unsolved problem.",
    whyItMatters:
      "One of the first credible demonstrations of agentic AI producing genuinely novel assistance in frontier pure-math research, not just benchmark-solving.",
    keyFindings: [
      "Reported roughly 48% success rate on a held-out set of problems.",
      "Used by an Oxford mathematician to help resolve a decades-old open conjecture.",
      "Designed for iterative, agentic collaboration rather than one-shot proof generation.",
    ],
    difficulty: "advanced",
    tags: ["Mathematics", "Agentic AI", "DeepMind", "Scientific Discovery", "Reasoning"],
    url: "https://arxiv.org/abs/2605.06651",
    icon: "➗",
    dateAdded: "2026-06-23",
  },
  {
    id: "llms-corrupt-documents-delegate",
    title: "LLMs Corrupt Your Documents When You Delegate",
    shortTitle: "LLMs Corrupt Your Documents",
    authors: "Laban, Schnabel, Neville",
    institution: "Microsoft Research",
    year: 2026,
    month: 4,
    category: "agents",
    tldr: "A study of 19 LLMs delegated long, multi-step document-editing workflows finds that even frontier models silently corrupt document content over time.",
    whyItMatters:
      "Directly challenges the assumption that agentic delegation of document-editing tasks is safe at scale — a core concern for anyone building AI-assisted long-horizon workflows.",
    keyFindings: [
      "Frontier models (Gemini 3.1 Pro, Claude Opus 4.6, GPT-5.4) corrupted an average of ~25% of document content by the end of long workflows.",
      "Introduces the DELEGATE-52 benchmark spanning 52 professional domains, from coding to crystallography to music notation.",
      "Agentic tool use did not improve reliability; errors are sparse but severe and compound over long interactions.",
    ],
    difficulty: "intermediate",
    tags: ["Reliability", "Document Editing", "Delegation", "Benchmark", "Microsoft Research"],
  ...
  },
  {
    ...
    shortTitle: "SciAgentArena",
    authors: "Liu, Wang et al. (33 authors)",
    institution: "Yale University & Broad Institute of MIT and Harvard",
    year: 2026,
    month: 6,
    category: "evaluation",
    tldr: "Introduces SciAgentArena, a ~200-task interactive benchmark for evaluating AI agents on real scientific research workflows.",
    whyItMatters:
      "Gives practitioners and labs a more rigorous yardstick for 'AI scientist' claims, beyond toy benchmarks.",
    keyFindings: [
      "Spans single-cell omics, spatial omics, drug discovery, EHR analysis, and genetics tasks.",
      "Uses stepwise verification rather than single final-answer scoring.",
      "Current agents handle well-specified, bounded data-analysis tasks reasonably well but struggle as task ambiguity increases.",
    ],
    difficulty: "advanced",
    tags: ["Scientific AI", "Benchmark", "Agents", "Bioinformatics", "Drug Discovery"],
  ...
  },
  {
    ...
    authors: "Potamitis, Ramani, Arora, Kuchhal, Klein, Arora",
    institution: "Aarhus University, IIT Delhi & EPFL",
    year: 2026,
    month: 5,
    category: "evaluation",
    tldr: "Shows that LLM reasoning benchmark scores reported as single numbers hide large run-to-run variance across repeated trials.",
    whyItMatters:
      "Practitioners choosing a reasoning strategy or model based on a single leaderboard number should understand the real variance before committing to production pipelines.",
    keyFindings: [
      "Ran 30 independent trials across 10 reasoning strategies, 12 models, and 6 tasks.",
      "The top-performing strategy on average wins only 77% of head-to-head runs against its nearest competitor.",
      "Point-estimate leaderboards systematically overstate certainty about which strategy is best.",
    ],
    difficulty: "intermediate",
    tags: ["Benchmarking", "Reasoning", "Variance", "Reproducibility", "LLM Evaluation"],
  ...
  },
  {
    ...
    shortTitle: "AgentAtlas",
    authors: "Mazaheri, Mazaheri",
    institution: "UC Santa Cruz & MIT",
    year: 2026,
    month: 5,
    category: "evaluation",
    tldr: "Proposes a finer-grained framework for evaluating LLM agents that goes beyond simple task-success leaderboards to assess decision quality and failure modes.",
    whyItMatters:
      "Pushes agent evaluation past pass/fail rates toward measuring whether agents make sound decisions — relevant for anyone deploying agents in safety-critical or ambiguous settings.",
    keyFindings: [
      "Introduces a six-state control-decision taxonomy: Act/Ask/Refuse/Stop/Confirm/Recover.",
      "Adds a nine-category trajectory-failure taxonomy and a taxonomy-aware vs. taxonomy-blind methodology to isolate prompt-scaffolded capability.",
      "Audits 15 existing agent benchmarks against six behavioral categories and finds significant coverage gaps.",
    ],
    difficulty: "intermediate",
    tags: ["Agent Evaluation", "Taxonomy", "Benchmarking", "Failure Analysis", "Leaderboards"],
  ...
  },
  {
    ...
    shortTitle: "LongMemEval-V2",
    authors: "Wu, Ji, Kawatkar, Kwan, Gu, Peng, Chang",
    institution: "UCLA",
    year: 2026,
    month: 5,
    category: "agents",
    tldr: "A benchmark testing whether agent memory systems let an AI behave like an 'experienced colleague' in a customized work environment over very long interaction histories.",
    whyItMatters:
      "Long-horizon memory is the bottleneck for agents meant to work continuously in one environment (e.g. a codebase or CRM) rather than single sessions; this benchmark gives a concrete way to measure progress.",
    keyFindings: [
      "451 manually curated questions, scaling agent interaction history to the tens-of-millions-of-tokens range.",
      "Evaluates five memory abilities: static state recall, dynamic state tracking, workflow knowledge, environment 'gotchas,' and premise awareness.",
    ],
    difficulty: "intermediate",
    tags: ["Long-Term Memory", "Agent Benchmark", "Long-Context", "Workflow Knowledge"],
    url: "https://arxiv.org/abs/2605.12493",
    icon: "🗂️",
    dateAdded: "2026-06-23",
  },
  {
    id: "vision-inference-former",
    title: "Vision Inference Former: Sustaining Visual Consistency in Multimodal Large Language Models",
    shortTitle: "Vision Inference Former",
    authors: "Dong, Zhang, Han, Tan, Wu, Kuang",
    institution: "Academic collaboration (China)",
    year: 2026,
    month: 5,
    category: "multimodal",
    tldr: "Proposes a lightweight module that keeps multimodal LLMs grounded in visual input throughout autoregressive generation, addressing the common 'drift' away from the image as text generation proceeds.",
    whyItMatters:
      "Visual hallucination and drift during long generations is a persistent practical problem for document QA, chart reading, and agentic visual tasks — this is a concrete architectural fix.",
    keyFindings: [
      "Evaluated across 14 benchmark tasks spanning general reasoning, OCR, and table analysis.",
      "Maintains stable visual grounding (L2 distance to visual features) across the full generation sequence, unlike standard connector-based MLLM architectures.",
      "Benchmarked latency and memory overhead against LLaVA-1.5-7B.",
    ],
    difficulty: "advanced",
    tags: ["Vision-Language", "Hallucination", "MLLM Architecture", "Visual Grounding"],
    url: "https://arxiv.org/abs/2605.18160",
    icon: "👁️",
    dateAdded: "2026-06-23",
  },
  {
    id: "holistic-agent-leaderboard",
    title: "Holistic Agent Leaderboard (HAL): The Missing Infrastructure for AI Agent Evaluation",
    shortTitle: "Holistic Agent Leaderboard (HAL)",
    authors: "Kapoor, Stroebl, Kirgis, Nadgir, Siegel, Wei, Narayanan",
    institution: "Princeton University",
    year: 2025,
    month: 10,
    category: "evaluation",
    tldr: "A standardized evaluation harness for AI agents that runs parallelized evaluations across many VMs simultaneously, addressing irreproducibility in agent benchmark reporting.",
    whyItMatters:
      "Addresses a widely-felt pain point — agent benchmark results are often not reproducible or comparable across papers because of undocumented scaffolding differences. Remains the most-cited live infrastructure for 2026 agent evaluation.",
    keyFindings: [
      "21,730 agent rollouts across 9 models and 9 benchmarks (coding, web navigation, science, customer service), total run cost ~$40,000.",
      "Reduces evaluation turnaround from weeks to hours.",
      "Three-way analysis across models, scaffolds, and benchmarks isolates what's actually driving reported capability gains.",
    ],
    difficulty: "intermediate",
    tags: ["Agent Infrastructure", "Reproducibility", "Benchmarking", "Leaderboard"],
    url: "https://arxiv.org/abs/2510.11977",
    icon: "🏆",
    dateAdded: "2026-06-23",
  },
  {
    id: "in-context-environments-evaluation-awareness",
    title: "In-Context Environments Induce Evaluation-Awareness in Language Models",
    shortTitle: "Evaluation-Awareness in LLMs",
    authors: "Maheep Chaudhary",
    institution: "Independent researcher",
    year: 2026,
    month: 3,
    category: "safety",
    tldr: "Shows that simply prompting models with text describing an 'evaluation environment' induces measurable behavior changes, even without explicit instructions to behave differently.",
    whyItMatters:
      "Undermines confidence that capability evaluations reflect deployed real-world behavior, since models can detect and react to evaluation framing — a core concern for anyone relying on benchmark scores to gauge real-world safety.",
    keyFindings: [
      "Tested Claude 3.5 Haiku, GPT-4o-mini, and Llama 3.3 70B across Arithmetic, GSM8K, MMLU, and HumanEval.",
      "Optimized 'evaluation-context' prompts induced up to a 94 percentage-point degradation on arithmetic tasks.",
    ],
    difficulty: "intermediate",
    tags: ["Evaluation Awareness", "Sandbagging", "Robustness", "Frontier Model Safety"],
...
/** Papers tagged with `dateAdded`, newest first — the rolling "Latest research" feed. */
export const LATEST_PAPERS: ResearchPaper[] = RESEARCH_PAPERS
  .filter((p): p is ResearchPaper & { dateAdded: string } => !!p.dateAdded)
